(function () {
  if (window.blugridLoaded) return;
  window.blugridLoaded = true;

  const WEBHOOK_URL = "https://maxton-ethnolinguistic-derelictly.ngrok-free.dev/webhook/blugrid-ai-assistant";
  const BOOKING_URL = "https://calendly.com/posthumus-blugridsystems";
  const BRAND_NAME = "BluGrid AI Assistant";
  const BRAND_SUBTITLE = "Sales • Support • Qualification";
  const BRAND_LOGO = "https://blugridposti.github.io/blugrid-demo/logo.png";
  ...
  box.innerHTML = `
    <div id="bg-header">
      <div class="bg-headrow">
        <div class="bg-brand-wrap">
          <div class="bg-brand-badge">
            <img src="${BRAND_LOGO}" alt="BluGrid Logo" />
          </div>
          <div>
            <div class="bg-title">${BRAND_NAME}</div>
            <div class="bg-sub">${BRAND_SUBTITLE}</div>
          </div>
        </div>
      ...
      <div class="bg-chips">
        <button class="bg-chip" data-prompt="What do you guys do?">What do you do?</button>
        <button class="bg-chip" data-prompt="How can an AI assistant help my business?">AI assistant value</button>
        <button class="bg-chip" data-prompt="How quickly can this be deployed?">Deployment speed</button>
  ...
  function renderWelcome() {
    messages.innerHTML = "";
    add(
      "Hi — welcome to BluGrid. I can answer questions, explain our systems, and help you book a call or request a custom solution.",
      "bot"
    );
  }
  ...
  function showLeadForm() {
    ...
    card.innerHTML = `
      ...
      <p>Drop your details and BluGrid can follow up with a tailored solution.</p>
      ...
      <div class="bg-field">
        ...
        <select id="bg-lead-service">
          ...
          <option value="Full system build">Full system build</option>
        </select>
      </div>

      <div class="bg-field">
        <label>Biggest problem</label>
        <textarea id="bg-lead-problem" placeholder="Missed leads, slow admin, poor follow-up, disconnected systems..."></textarea>
      </div>
    ...
    try {
      ...
      if (data.ok) {
        box.querySelector("#bg-lead-card").innerHTML = `
          ...
          <p>Perfect — BluGrid has your details. Someone should follow up shortly.</p>
          <div class="bg-actions">
        ...
        add("Thanks — your details have been captured. BluGrid will follow up with you shortly.", "bot");
      } else {
    ...
    try {
      const res = await fetch(WEBHOOK_URL, {
        ...
        body: JSON.stringify({
          ...
          metadata: {
            business_name: "BluGrid",
            services: "custom business software, automation systems, AI assistants, dashboards, portals, lead generation systems"
          }
        })
      });
